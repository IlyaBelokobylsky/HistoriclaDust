...
(function() {
    ...
    function takeTest() {
        let difficult,
            ...
            [
                // strings
                new StringQuestion('Как называлась древняя религия, <br> основанная на обожествлении вещей?', 'Фетишизм', ['Анимизм', 'Тотемизм', 'Буддизм'], 1),
                new StringQuestion('Как называлась древняя религия, <br> основанная на вере в духов?', 'Анимизм', ['Фетишизм', 'Тотемизм', 'Буддизм'], 1),
                new StringQuestion('Как называлась древняя религия, <br> основанная на вере в связь с тотемом?', 'Тотемизм', ['Фетишизм ', 'Анимизм', 'Буддизм'], 1),
                ...
                new StringQuestion('В какой период античности начали <br> формироваться полисные структуры?', '"Темные века"', ['Крито-микенская эпоха', 'Архаическая Греция', 'Классическая Греция'], 1),
                new StringQuestion('В какой период античности начали <br> формироваться идеи гуманизма?', 'Классическая Греция', ['Крито-микенская эпоха', 'Архаическая Греция', '"Темные века"'], 1),
                ...
                new StringQuestion('В какой период нового времени <br> окончилась промышленная революция?', '"Долгий XIX век"', ['Просвещение', 'Раннее новое время', 'Реннесанс'], 1),
                ...
                new NumberQuestion('Назовите дату подписания <br> крестьянской.', 1945, 'год'),
            ...
            [
                ...
                new StringQuestion('Как называли серию вооруженных <br> конфликтов между британскими династиями?', 'Война роз', ['Война пик', 'Война тюльпанов', 'Война справедливости'], 2),
                new StringQuestion('Как назывался пакт о разделе <br> сфер влияния между СССР и Германией?', 'Молотова-Риббентропа', ['Гитлера-Сталина', 'Антикоминтерновский', 'Бриана-Келлога'], 2),
